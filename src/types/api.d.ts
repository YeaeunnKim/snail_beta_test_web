...
export interface paths {
    ...
    "/api/v1/admin/settlements": {
        ...
        /** 운영자 정산 목록 */
        get: operations["admin_list_settlements"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/admin/settlements/queue": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * 운영자 지급 대기 큐(오늘 보낼 목록)
         * @description 지급해야 할 정산서와 총액. 운영자가 은행앱을 열기 전에 보는 화면이다.
         */
        get: operations["admin_payout_queue"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/admin/settlements/{settlement_id}": {
        ...
        /** 운영자 정산 상세 */
        get: operations["admin_get_settlement"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/admin/settlements/{settlement_id}/pay": {
        ...
        put?: never;
        /** 운영자 송금 완료 기록 */
        post: operations["admin_mark_settlement_paid"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/admin/settlements/{settlement_id}/fail": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        put?: never;
        /** 운영자 송금 실패 기록 */
        post: operations["admin_mark_settlement_failed"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/admin/settlements/{settlement_id}/hold": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        put?: never;
        /** 운영자 지급 보류 설정·해제 */
        post: operations["admin_hold_settlement"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/admin/settlements/adjustments": {
        ...
        /**
         * 운영자 정산 조정 항목 생성
         * @description 이미 지급이 끝난 건에 환불·과지급이 생겼을 때 **다음 정산에서** 바로잡는다.
         *
         *     과거 정산서는 고치지 않는다 — 돈이 이미 나갔으므로 그것은 사실의 기록이다.
         */
        post: operations["admin_create_adjustment"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/shops/me/settlements": {
        ...
        /** 사장님 정산 내역 목록 */
        get: operations["settlements_list_my_settlements"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/shops/me/settlements/upcoming": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** 사장님 지급 예정 금액(마감 전) */
        get: operations["settlements_my_upcoming_settlement"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/shops/me/settlements/{settlement_id}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** 사장님 정산 내역 상세 */
        get: operations["settlements_get_my_settlement"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
         ...
         * @description 조정 항목. 음수면 다음 정산에서 차감, 양수면 가산이다.
         *
         *     사유를 필수로 받는다 — 금액만 남으면 매장 문의에 답할 수 없고, 조정은 매장의 돈을
         *     건드리는 일이라 근거가 화면에 보여야 한다.
         */
        AdminSettlementAdjustment: {
            /**
             * Shop Id
        ...
        /** AdminSettlementFailRequest */
        AdminSettlementFailRequest: {
            /** Reason */
            reason: string;
        };
        /** AdminSettlementHoldRequest */
        AdminSettlementHoldRequest: {
            /** On Hold */
            on_hold: boolean;
            /** Reason */
         ...
         * @description 송금 완료 기록.
         *
         *     `payout_reference` 를 필수로 받는다 — 은행 거래번호(지급대행으로 넘어가면 대행사의
         *     지급요청 ID)가 없으면 나중에 "이 돈이 정말 나갔나" 를 대조할 방법이 없다. 지급 완료는
         *     되돌릴 수 없는 기록이므로 근거 없이 찍히면 안 된다.
         */
        AdminSettlementPayRequest: {
            /** Payout Reference */
        ...
        /**
         * AdminSettlementQueue
         * @description 지급 대기 큐. 운영자가 은행앱을 열기 전에 보는 화면이다.
         */
        AdminSettlementQueue: {
            /** Total Payout Amount */
            ...
            /** Settlements */
            settlements: components["schemas"]["SettlementSummary"][];
        };
        /** AdminShopSummary */
        AdminShopSummary: {
            /**
        ...
        /**
         * DesignOptionSelectionType
         * @description 옵션 하나가 켜고 끄는 형태인지, 개수를 고르는 형태인지.
         *     QUANTITY 인 옵션은 price_delta/duration_delta_min 이 "1개당" 값이 되고,
         *     고객이 max_quantity 이하로 개수를 골라 그만큼 곱해진다.
         * @enum {string}
         */
        DesignOptionSelectionType: "toggle" | "quantity";
        /** DesignOptionUpdate */
        DesignOptionUpdate: {
            /**
            ...
            /** Template Key */
            template_key?: string | null;
            selection_type?: components["schemas"]["DesignOptionSelectionType"] | null;
            /** Max Quantity */
            max_quantity?: number | null;
        };
        /** DesignPublic */
        ...
        /**
         * OptionSelectionMode
         * @description 샵이 카테고리(kind)별로 고르는, 고객 예약 시 옵션 선택 방식.
         *     SINGLE: 그 kind 안에서 옵션을 최대 1개까지만 고를 수 있음(라디오 버튼).
         *     MULTI: 여러 개를 동시에 고를 수 있음(체크박스) — 기존 동작과 동일한 기본값.
         * @enum {string}
         */
         ...
         *     CANCELLED = 승인 후 전액 취소(환불).
         *     PARTIALLY_CANCELLED = 승인 후 일부만 취소. 매장별 환불 규정이 부분 환불을 정할 수
         *         있어 생긴 상태다(2026-09-03). 남은 금액은 매장에 지급된다 — 즉 CANCELLED 와 달리
         *         **아직 돈이 남아 있는** 상태이므로 정산 대상에서 빼면 안 된다.
         * @enum {string}
         */
        PaymentStatus: "pending" | "paid" | "failed" | "cancelled" | "partially_cancelled";
        /** QuotePreviewRequest */
        QuotePreviewRequest: {
            /** Body */
            body?: string | null;
        ...
        /**
         * SettlementDetail
         * @description 요약 + 항목 목록 + 송금 계좌 스냅샷.
         *
         *     계좌를 응답에 싣는 이유: 매장이 "어디로 보냈나" 를 확인해야 분쟁이 끝난다. 계좌번호는
         *     마스킹해서 내린다 — 전체를 다시 보여줄 이유가 없고, 화면 캡처가 그대로 유출 경로가 된다.
         */
        SettlementDetail: {
            /**
             * Id
            ...
            note?: string | null;
            /** Items */
            items: components["schemas"]["SettlementItemRow"][];
        };
        /**
         * SettlementEligibility
         * @description 항목이 정산 적격이 된 근거. 매장 문의에 "왜 이 날짜부터인가" 로 답하는 값이다.
         *
         *     OWNER_COMPLETED = 사장님이 [시술 완료] 를 눌렀다. 그 시각부터 적격이다(가장 빠르다).
         *     AUTO_AFTER_TREATMENT = 사장님이 아무것도 누르지 않아 시술 예정일 + 유예기간 경과로
         *         자동 적격이 됐다. 자동 구매확정에 해당하는 장치다 — 이것이 없으면 사장님이
         *         완료를 누르지 않은 예약의 돈이 영구히 묶인다.
         *     CANCELLATION_FEE = 확정 후 이용자 취소로 부분 환불이 일어나고 **남은 금액**이 있는
         *         경우다. 그 잔액은 매장이 정한 규정에 따른 위약금 성격이라 매장 몫이다.
         * @enum {string}
         */
        SettlementEligibility: "owner_completed" | "auto_after_treatment" | "cancellation_fee";
        /**
         * SettlementItemKind
         * @description 정산 항목의 종류.
         *
         *     DEPOSIT    = 예약금 1건에서 나온 항목. `payment_id` 가 반드시 있고 금액은 양수다.
         *     ADJUSTMENT = 운영자가 만드는 조정 항목. 이미 지급이 끝난 건에 환불·과지급이 생겼을 때
         *                  **과거 정산서를 고치지 않고** 다음 정산서에서 차감·가산하기 위한 자리다.
         *                  금액이 음수일 수 있고 `payment_id` 가 없을 수 있다.
         * @enum {string}
         */
        SettlementItemKind: "deposit" | "adjustment";
        /**
         * SettlementItemRow
         * @description 정산 한 줄. 매장이 "이 돈이 어느 예약에서 왔나" 를 확인하는 단위다.
         */
        SettlementItemRow: {
            /**
             * Id
             ...
             */
            id: string;
            kind: components["schemas"]["SettlementItemKind"];
            /** Reservation Id */
            reservation_id?: string | null;
            /** Payment Id */
             ...
             */
            eligible_at: string;
            eligibility?: components["schemas"]["SettlementEligibility"] | null;
            /** Note */
            note?: string | null;
        };
        ...
        /**
         * SettlementStatus
         * @description 정산서(매장 x 정산주기) 1건의 상태.
         *
         *     PENDING  = 마감이 끝나 지급을 기다리는 상태. 금액이 확정돼 있다.
         *     PAID     = 송금 완료. **이 상태의 정산서와 그 항목은 더 이상 바뀌지 않는다** —
         *                돈이 이미 나갔으므로 사후 수정이 아니라 다음 정산의 조정 항목으로 반영한다.
         *     ON_HOLD  = 운영자 보류(계좌 미비·분쟁·본인 확인 등). 지급 대상에서 빠지되 금액은 유지된다.
         *     FAILED   = 송금 시도가 실패했다. 사유를 남기고 PENDING 으로 되돌려 재시도한다.
         * @enum {string}
         */
        SettlementStatus: "pending" | "paid" | "on_hold" | "failed";
        /**
         * SettlementSummary
         * @description 정산서 1건의 요약. 금액은 **마감 시점에 고정된 값**이고 다시 더해 구하지 않는다.
         */
        SettlementSummary: {
            /**
             * Id
        ...
        ShopCreate: {
            ...
            /** Refund Tiers */
            refund_tiers?: components["schemas"]["RefundTierIn"][] | null;
        ...
        ShopMe: {
            ...
            reservation_policy?: string | null;
            /** Refund Tiers */
            refund_tiers?: components["schemas"]["RefundTierIn"][];
            /** Refund Policy Notice */
            refund_policy_notice?: string[];
            /** Default Design Duration Min */
            default_design_duration_min?: number | null;
        ...
        ShopUpdate: {
            ...
            removal_selection_mode?: components["schemas"]["OptionSelectionMode"] | null;
            extend_selection_mode?: components["schemas"]["OptionSelectionMode"] | null;
            care_selection_mode?: components["schemas"]["OptionSelectionMode"] | null;
        };
        ...
        /**
         * UpcomingSettlement
         * @description 아직 마감되지 않은(지급 예정) 금액.
         *
         *     매장 화면에 이것이 없으면 "시술은 끝났는데 정산 내역에 아무것도 없다" 로 보인다 —
         *     마감 주기가 주 1회라 최대 일주일 동안 그 상태가 된다. 문의를 미리 막는 값이다.
         */
        UpcomingSettlement: {
            /** Item Count */
            item_count: number;
...
export interface operations {
    ...
    admin_payout_queue: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["AdminSettlementQueue"];
                };
            };
            /** @description UNAUTHORIZED */
            401: {
    ...
    admin_mark_settlement_paid: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["AdminSettlementPayRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    admin_mark_settlement_failed: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["AdminSettlementFailRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    admin_hold_settlement: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["AdminSettlementHoldRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    admin_create_adjustment: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["AdminSettlementAdjustment"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    settlements_list_my_settlements: {
        parameters: {
            query?: {
                status?: components["schemas"]["SettlementStatus"] | null;
                limit?: number;
    ...
    settlements_my_upcoming_settlement: {
        parameters: {
            query?: never;
            header?: {
                authorization?: string | null;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["UpcomingSettlement"];
                };
            };
            /** @description UNAUTHORIZED */
            401: {
